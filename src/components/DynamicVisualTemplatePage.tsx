    ...
    return (
      <div className="min-h-[100svh] bg-[#fffaf8] text-[#191919]">
        ...
        <main className="mx-auto grid max-w-7xl gap-10 px-5 py-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-center lg:px-8 lg:py-16">
          ...
          <div className="mx-auto max-h-[720px] w-full max-w-[430px] overflow-y-auto overflow-x-hidden rounded-[28px] border border-black/7 bg-white shadow-[0_28px_80px_rgba(70,25,40,0.12)]">
